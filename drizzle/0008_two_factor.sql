...
ALTER TABLE "app_settings" ADD COLUMN "two_factor_required_roles" text[] DEFAULT '{}'::text[] NOT NULL;--> statement-breakpoint
ALTER TABLE "app_settings" ADD COLUMN "two_factor_deadline" date;--> statement-breakpoint
